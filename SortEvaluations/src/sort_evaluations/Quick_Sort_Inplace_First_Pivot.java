 ...
 */
public class Quick_Sort_Inplace_First_Pivot // FIXME: make Quicksort the parent class
{
	...
	{
		// FIXME: follow the above instructions 
	}
	...
	{
		return "name of sort, with insertion cutoff";
	}
