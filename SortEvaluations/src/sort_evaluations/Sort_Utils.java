...
public class Sort_Utils
{
	...
	{
		// FIXME: write code to sum up the values in the two arrays and return true if they are the same.
	...
	{
		// FIXME: write this code. should take less than 3 minutes to write. Use a Random number generator 
	}
	...
	{
		// FIXME: write this code. should generate an array of SIZE elements each of value ELEMENT
	}
